...
**Purpose:** Score large CSV/Excel files with memory-safe chunked processing and a formatted Excel report.
...
```
300 records | 3 chunks | n_mc=300
  Chunk 1/3: records 0–100   (0.01s)
  Chunk 2/3: records 100–200 (0.01s)
  Chunk 3/3: records 200–300 (0.00s)
Complete: 300 records in 0.54s (555 records/sec)
```

**Risk tier distribution from test run:**
```
High       10  ( 3.3%)  █
Moderate  105  (35.0%)  █████████████████
Low        72  (24.0%)  ████████████
...
```bash
# Basic run
python phase5_batch.py --input records.csv --output results.xlsx
